...
public interface BasicController {
  ...
  Message newMessage(Uuid author, Uuid conversation, String body, boolean databaseAdd);
  ...
  //   is undefined.
  User newUser(String name, String hash, String salt, boolean databaseAdd);
  ...
  Conversation newConversation(String title, Uuid owner, boolean databaseAdd);
